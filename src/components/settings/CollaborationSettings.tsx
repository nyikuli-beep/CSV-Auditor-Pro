  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
        ...
        <button
          type="button"
          onClick={() => resetCategory('collaboration')}
      ...
      <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-2">
        ...
        >
          <option value="public" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Public (Visible to All Workspace Members)</option>
          <option value="team" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Team Only (Visible to Assigned Team)</option>
          <option value="private" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Private (Only Visible to Me)</option>
        </select>
      </div>
    </div>
  );
