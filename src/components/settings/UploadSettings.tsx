    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-2">
          ...
          >
            <option value="auto" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Auto-Detect Encoding</option>
            <option value="utf-8" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">UTF-8 (Unicode Standard)</option>
            <option value="utf-16" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">UTF-16</option>
            <option value="ascii" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">ASCII / Windows-1252</option>
          </select>
        </div>
        ...
        <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-2">
          ...
          <select
            ...
            className="w-full p-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-xs font-semibold text-slate-900 dark:text-slate-100 cursor-pointer"
          >
            <option value="YYYY-MM-DD" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">YYYY-MM-DD (ISO 8601)</option>
            <option value="MM/DD/YYYY" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">MM/DD/YYYY (US Standard)</option>
            <option value="DD/MM/YYYY" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">DD/MM/YYYY (UK / EU Standard)</option>
          </select>
        </div>
