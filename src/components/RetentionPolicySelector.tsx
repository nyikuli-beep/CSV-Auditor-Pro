          ...
          return (
            ...
            >
              <div className="flex items-start justify-between w-full mb-1">
                <span className={`text-xs font-bold ${isSelected ? 'text-[#2563EB] dark:text-blue-400' : ''}`}>
                  {opt.badge}
                </span>
                {isSelected && (
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="px-2 py-0.5 rounded text-xs font-bold bg-[#DBEAFE] text-[#2563EB] dark:bg-[#1D4ED8]/30 dark:text-blue-300 border border-blue-200 dark:border-blue-700">
                {detail.badge}
              </span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2">
            {RETENTION_OPTIONS.map((opt) => {
              ...
              return (
                ...
                >
                  <span className="text-xs block font-bold">{opt.badge}</span>
                </button>
              );
            })}
          </div>
