        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-800/40">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] font-mono uppercase text-slate-400 font-bold">Join Enterprise Workspace</span>
            </div>
          </div>
          <button
            type="button"
            ...
            <div className="space-y-4 text-center py-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-400">
                  You have joined as an <strong className="text-blue-400 font-mono">{successMember.role}</strong>. Your account now has full access to the shared Enterprise workspace.
                </p>
              </div>
              <div className="pt-3">
                <button
            ...
            <form onSubmit={handleAccept} className="space-y-4">
              <div>
                <label className="block text-xs font-bold uppercase font-mono text-slate-400 mb-1.5">
                  Invitation Token or ID <span className="text-rose-400">*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div className={`p-3.5 rounded-xl border text-xs flex items-center gap-3 ${
                ...
                <div className="min-w-0">
                  <span className="text-[10px] font-mono text-slate-400 block uppercase font-bold">Signed in as</span>
                  <span className="font-bold text-xs truncate block">{user?.email || 'Authenticated User'}</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isLoading ? (
                    <>
