    ...
    <div className={`min-h-screen transition-colors duration-200 font-sans ${
      ...
      <section className={`py-12 px-4 sm:px-6 lg:px-8 border-b ${
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-mono font-semibold ${
            ...
            <span>Billing Guarantee & Cancelation Terms</span>
          </div>
          ...
          <p className={`text-sm sm:text-base max-w-2xl mx-auto leading-relaxed ${
            ...
            We believe in complete billing transparency. Review our 14-day refund guarantee and subscription cancellation terms below.
          </p>
      ...
      <main className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        <div className={`p-6 rounded-2xl border text-sm leading-relaxed space-y-4 ${
          ...
          <h2 className="text-lg font-bold text-[#0F172A] dark:text-[#F8FAFC]">1. 14-Day Money-Back Guarantee</h2>
          <p>If you are dissatisfied with CSV Auditor Pro Pro or Enterprise tier for any reason within the first 14 days of purchase, contact us for a 100% full refund—no questions asked.</p>
        </div>

        <div className={`p-6 rounded-2xl border text-sm leading-relaxed space-y-4 ${
          isDarkMode ? 'bg-[#1E293B] border-[#334155] text-[#CBD5E1]' : 'bg-white border-[#E2E8F0] text-[#475569]'
        }`}>
          <h2 className="text-lg font-bold text-[#0F172A] dark:text-[#F8FAFC]">2. Subscription Cancellation</h2>
          <p>You can cancel your subscription at any time via your Account Settings or directly through Paddle billing emails. After cancellation, you maintain full access through the end of your current paid billing cycle.</p>
        </div>

        <div className={`p-6 rounded-2xl border text-sm leading-relaxed space-y-4 ${
          isDarkMode ? 'bg-[#1E293B] border-[#334155] text-[#CBD5E1]' : 'bg-white border-[#E2E8F0] text-[#475569]'
        }`}>
          <h2 className="text-lg font-bold text-[#0F172A] dark:text-[#F8FAFC]">3. Requesting a Refund</h2>
          <p>To request a refund, please email our support team at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-[#2563EB] dark:text-[#60A5FA] font-bold hover:underline">{SUPPORT_EMAIL}</a> with your account email and Paddle receipt order ID. Refunds are processed within 3-5 business days.</p>
        </div>
      </main>
