      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 space-y-2">
          ...
          <div className="flex items-center justify-center gap-2.5">
            ...
            <h1 className="text-2xl font-extrabold tracking-tight">CSV Auditor Pro</h1>
          </div>
          <p className="text-xs text-slate-400">Sign in to your account to manage data hygiene</p>
        </div>
        ...
        <div className="bg-[#1E293B] border border-[#334155] rounded-2xl p-6 sm:p-8 shadow-xl space-y-5">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer text-xs text-slate-400">
                <input
                  ...
                  className="w-4 h-4 rounded border-[#334155] bg-[#0F172A] text-blue-600 focus:ring-blue-500/20 cursor-pointer"
                />
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 text-white font-bold text-sm transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer mt-2"
            >
              {isLoading ? (
                <>
