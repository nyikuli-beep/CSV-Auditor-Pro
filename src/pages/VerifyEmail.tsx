        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 sm:p-8 shadow-xl space-y-6">
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-slate-300 leading-relaxed">
              ...
              <span className="font-bold text-white underline decoration-blue-500">{user?.email || 'your email address'}</span>.
            </p>
          ...
          <div className="space-y-3 pt-2">
            ...
            <button
              ...
              disabled={isChecking}
              className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isChecking ? (
                <>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-slate-900 border border-slate-700 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSending ? (
                <>
                  <RefreshCw className="w-4 h-4 animate-spin text-blue-400" /> Sending Email...
                </>
              ) : cooldown > 0 ? (
          ...
          <div className="p-3 bg-slate-900/60 border border-slate-700 rounded-xl text-[11px] text-slate-400 text-center leading-normal">
            💡 Didn't receive the email? Check your <span className="text-slate-200 font-semibold">Spam/Junk</span> folder or ensure your email address was entered correctly.
          </div>
          ...
          <div className="pt-2 flex items-center justify-between border-t border-slate-700/60 text-xs text-slate-400">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-rose-400 hover:text-rose-300 transition-colors cursor-pointer font-medium"
            >
